...
import com.wayplaner.learn_room.service.LocationService
...
class MapSearchActivity : Activity(), Session.SearchListener,
    ...
    private lateinit var locale: LocationService;
    ...
    override fun onObjectTap(geoObjectTapEvent: GeoObjectTapEvent): Boolean {
        ...
        if (selectionMetadata != null) {
            ...
            searchEdit.setText(LocationService.parceLocationToAddress(this, geoObjectTapEvent.geoObject.geometry[0].point!!))
